...
namespace Patosearch.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<WebViewPSPage>("Shell_WebViewPS".GetLocalized(), Symbol.Find));
